...
First sort the processes as per arrival time.

Then find the Completion time for each processes

Now find Turnaround time using TAT = CT - AT

Finally find the Wait time using WT = TAT - BT
